        ...
        <table width="495" bordercolor="#ababab" border="1" cellspacing="0" cellpadding="3">
          ...
          <form name="myform1" method="post">
            ...
            <tr>
              ...
              <td align="center"><input type="radio" name="driver2" id="driver2grant" value="grant" <?php if ($statusNameArray['1'] == 'grant'){ echo 'checked'; } ?>></td>
              <td align="center"><input type="radio" name="meet" id="meetgrant" value="grant" <?php if ($statusNameArray['2'] == 'grant'){ echo 'checked'; } ?>></td>
            </tr>
            <tr>
          ...
          <td align="center"><input type="radio" name="driver1" id="driver1jimh" value="jimh" <?php if ($statusNameArray['0'] == 'jimh'){ echo 'checked'; } ?>></td>></td>
            ...
            <tr>
              ...
              <td align="center"><input type="radio" name="driver2" id="driver2ud" value="udml" <?php if ($statusNameArray['1'] == 'udml'){ echo 'checked'; } ?>></td>
              <td align="center"><input type="radio" name="meet" id="meetuml" value="udml" <?php if ($statusNameArray['2'] == 'udml'){ echo 'checked'; } ?>></td>
            </tr>
            </p>
          </tbody>
        </table>
...
Last updated at 2:58 pm PDT on 04/13/2017<br>
