...
<script>
	...
	$attendNameArray = ['tsai', 'neff', 'sahyounie', 'hartungj', 'fashehj', 'thornton', 'liu', 'rutherford', 'shoukry', 'ferkle', 'feinblatts', 'sahyounis', 'fasheha', 'english'];
	
	$nameArray = ['amy', 'angela', 'elias', 'jimh', 'john', 'julie', 'patty', 'phil', 'ralph', 'robert', 'shirley', 'sonia', 'tona', 'tricia'];
...
<div align="center">
  ...
  <table width="600" border="0" cellspacing="1" cellpadding="5">
    <tr>
		<td>
			...
			<p align="left"><strong><font color="#ff0000">IMPORTANT: PLEASE READ THE GUIDELINES IN RED BELOW.</font></strong>            
        ...
        <p align="left">For more detailed explanation and instructions on the use of this process, go to <a href="carpool_instructions.html">instructions</a>.</p>   
          ...
          <form name="myform1" method="post">
            <tr>
		      ...
		      <p><a href="hikes/1601.html">Hike 1601 Hollywood Sign from Brush Canyon</a><br>
            ...
            <tr>
              ...
              <td align="center"><input type="radio" name="angela" id="angelayes" value="Yes" <?php if ($rsvpArray[$index] == 'yes'){ echo 'checked'; $yes = $yes + 1; } ?>></td>
              <td align="center"><input type="radio" name="angela" id="angelano" value="No" <?php if ($rsvpArray[$index] == 'no'){ echo 'checked'; $no = $no + 1; } ?>></td>
              <td align="center"><input type="radio" name="angela" id="angelanr" value="NR" <?php if ($rsvpArray[$index] == 'nr'){ echo 'checked'; $nr = $nr + 1; } ?>></td>
              <td align="center"><input type="radio" name="driver1" id="driver1angela" value="angela" <?php if ($statusNameArray['0'] == 'angela'){ echo 'checked'; } ?>></td>
              
              <td align="center"><input type="radio" name="driver2" id="driver2angela" value="angela" <?php if ($statusNameArray['1'] == 'angela'){ echo 'checked'; } ?>></td>
              <td align="center"><input type="radio" name="meet" id="meetangela" value="angela" <?php if ($statusNameArray['2'] == 'angela'){ echo 'checked'; } ?>></td>
            ...
            <tr>
              ...
              <td align="center">4</td>
              <td align="center"><input type="radio" name="julie" id="julieyes" value="Yes" <?php if ($rsvpArray[$index] == 'yes'){ echo 'checked'; $yes = $yes + 1; } ?>></td>
              <td align="center"><input type="radio" name="julie" id="julieno" value="No" <?php if ($rsvpArray[$index] == 'no'){ echo 'checked'; $no = $no + 1; } ?>></td>
              <td align="center"><input type="radio" name="julie" id="julienr" value="NR" <?php if ($rsvpArray[$index] == 'nr'){ echo 'checked'; $nr = $nr + 1; } ?>></td>
              <td align="center"><input type="radio" name="driver1" id="driver1julie" value="julie" <?php if ($statusNameArray['0'] == 'julie'){ echo 'checked'; } ?>></td>
              
              <td align="center"><input type="radio" name="driver2" id="driver2julie" value="julie" <?php if ($statusNameArray['1'] == 'julie'){ echo 'checked'; } ?>></td>
              <td align="center"><input type="radio" name="meet" id="meetjulie" value="julie" <?php if ($statusNameArray['2'] == 'julie'){ echo 'checked'; } ?>></td>
			...
			<tr>
              ...
              <td align="center">5</td>
              <td align="center"><input type="radio" name="patty" id="pattyyes" value="Yes" <?php if ($rsvpArray[$index] == 'yes'){ echo 'checked'; $yes = $yes + 1; } ?>></td>
              <td align="center"><input type="radio" name="patty" id="pattyno" value="No" <?php if ($rsvpArray[$index] == 'no'){ echo 'checked'; $no = $no + 1; } ?>></td>
              <td align="center"><input type="radio" name="patty" id="pattynr" value="NR" <?php if ($rsvpArray[$index] == 'nr'){ echo 'checked'; $nr = $nr + 1; } ?>></td>
              <td align="center"><input type="radio" name="driver1" id="driver1patty" value="patty" <?php if ($statusNameArray['0'] == 'patty'){ echo 'checked'; } ?>></td>
             
              <td align="center"><input type="radio" name="driver2" id="driver2patty" value="patty" <?php if ($statusNameArray['1'] == 'patty'){ echo 'checked'; } ?>></td>
              <td align="center"><input type="radio" name="meet" id="meetpatty" value="patty" <?php if ($statusNameArray['2'] == 'patty'){ echo 'checked'; } ?>></td>
            ...
            <tr>
              <td align="center">Tricia</td>
              <td align="center">5</td>
              <td align="center"><input type="radio" name="tricia" id="triciayes" value="Yes" <?php if ($rsvpArray[$index] == 'yes'){ echo 'checked'; $yes = $yes + 1; } ?>></td>
              <td align="center"><input type="radio" name="tricia" id="triciano" value="No" <?php if ($rsvpArray[$index] == 'no'){ echo 'checked'; $no = $no + 1; } ?>></td>
              <td align="center"><input type="radio" name="tricia" id="tricianr" value="NR" <?php if ($rsvpArray[$index] == 'nr'){ echo 'checked'; $nr = $nr + 1; } ?>></td>
              <td align="center"><input type="radio" name="driver1" id="driver1tricia" value="tricia" <?php if ($statusNameArray['0'] == 'tricia'){ echo 'checked'; } ?>></td>
              
              <td align="center"><input type="radio" name="driver2" id="driver2tricia" value="tricia" <?php if ($statusNameArray['1'] == 'tricia'){ echo 'checked'; } ?>></td>
              <td align="center"><input type="radio" name="meet" id="meettricia" value="tricia" <?php if ($statusNameArray['2'] == 'tricia'){ echo 'checked'; } ?>></td>
  ...
  <p align="left"><font color="#ff0000"><strong>IMPORTANT<br>
    <br>
    1: OPEN A <u>NEW</u> CARPOOL PAGE IN THE BROWSER. DO NOT USE A CARPOOL PAGE THAT IS ALREADY OPEN.<br> 
    2: <u>REFRESH</u> THIS PAGE BY CLICKING THE CIRCULAR ARROW IN THE BROWSER ADDRESS WINDOW.<br> 
    
    3: YOU THEN HAVE ONE MINUTE TO CHOOSE YOUR SELECTION AND HIT SUBMIT.<br>
4: <u>CLOSE</u> THE CARPOOL PAGE. YOU ARE DONE.</strong></font></p>
  
    <p align="left"><font color="#ff0000"><strong>
        5: IF YOU SEE A POP-UP MESSAGE IN STEP 2, HIT <u>CANCEL</u>, EXIT THE CARPOOL PAGE, THEN RE-ENTER THE CARPOOL PAGE.<br>
        
        6: DO NOT USE THE BACK OR FORWARD BROWSER NAVIGATION ARROWS.<br>
        7: REPEAT STEPS 3 AND 4.</strong></font></p>
...
<!-- #BeginLibraryItem "/Library/navbar.lbi" --><div id="navigation">
  &nbsp;&nbsp;&nbsp; 
  <a href="index.html" title="Home">Home</a>&nbsp;&nbsp;&nbsp;
  <a href="about.html" title="About">About</a>&nbsp;&nbsp;&nbsp;
  <a href="site_map.html" title="Site-Map">Site-Map</a>&nbsp;&nbsp;&nbsp;
...
Last updated at 11:27 am PST on 12/192024<br>
