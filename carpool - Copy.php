...
<script>
	...
	$attendNameArray = ['tsai', 'neff', 'sahyounie', 'hartungj', 'fashehj', 'liu', 'rutherford', 'shoukry', 'ferkle', 'feinblatts', 'sahyounis', 'fasheha'];
	
	$nameArray = ['amy', 'angela', 'elias', 'jimh', 'john', 'patty', 'phil', 'ralph', 'robert', 'shirley', 'sonia', 'tona'];
...
Last updated at 4:33 pm PST on 12/06/2023<br>
