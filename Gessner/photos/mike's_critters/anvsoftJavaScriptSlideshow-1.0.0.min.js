...
this.desTransformOriginX=Number(a.getAttribute("desTransformOriginX"));this.desTransformOriginY=Number(a.getAttribute("desTransformOriginY"));this.videoAutoPlay=b.videoAutoPlay;this.bufferTime=b.bufferTime;this.videoControls=b.videoControls;a=b.thumbnailBasicXml;this.thumWidth=Number(a.getAttribute("thumWidth"));this.thumHeight=Number(a.getAttribute("thumHeight"));this.backgroundColor=a.getAttribute("backgroundColor").replace(/0x/g,"#");this.currentBackgroundColor=a.getAttribute("currentBackgroundColor").replace(/0x/g,
"#");this.backgroundAlpha=a.getAttribute("backgroundAlpha")/100;this.numberColor=a.getAttribute("numberColor").replace(/0x/g,"#");this.currentNumberColor=a.getAttribute("currentNumberColor").replace(/0x/g,"#");this.thumborder=Number(a.getAttribute("thumborder"));this.buttonColor=a.getAttribute("buttonColor").replace(/0x/g,"#");this.thumbnailArray=b.thumbnailArray;this.photoArray=b.photoArray;this.photoUrlArray=b.photoUrlArray;this.URLTarget=b.URLTarget;this.videoArray=b.videoArray;this.transitionArray=
b.transitionArray;this.photoTimeArray=b.photoTimeArray;this.transitionTimeArray=b.transitionTimeArray;this.defineTransitionArray=b.defineTransitionArray;this.photoTitleArray=b.photoTitleArray;this.descriptionText=b.descriptionText;this.photoCount=this.photoArray.length;this.Play=function(){b.Play()};this.Pause=function(){b.Pause()};this.Previous=function(){b.Previous()};this.Next=function(){b.Next()};this.Show=function(a,c){b.Show(a,c)};this.MusicPlay=function(){b.MusicPlay()};this.MusicPause=function(){b.MusicPause()}}})();(function(){aJSsTemplate.ColorConverter={hexToRGB:function(b){var a,c,d;if(/rgb/.test(b))b=b.match(/\d+/g),a=parseInt(b[0]),c=parseInt(b[1]),d=parseInt(b[2]);else if(/#/.test(b)){var f=b.length;7===f?(a=parseInt(b.slice(1,3),16),c=parseInt(b.slice(3,5),16),d=parseInt(b.slice(5),16)):4===f&&(a=parseInt(b.charAt(1)+b.charAt(1),16),c=parseInt(b.charAt(2)+b.charAt(2),16),d=parseInt(b.charAt(3)+b.charAt(3),16))}else return b;return{r:a,g:c,b:d}}}})();(function(){aJSsTemplate.JsBackground=function(){}})();(function(){aJSsTemplate.JsText=function(b,a){function c(a){a=a.index;""!=n[a]?(G.style.display="true"!==q?"block":"none",G.textContent=n[a]):G.style.display="none"}function d(){"true"==q&&(G.style.display="none",u.style.cursor="pointer",a.addEventListener("mouseover",e),a.addEventListener("mouseout",h))}function f(a){a=a.index;""!=J[a]?(t.style.display="block",t.innerHTML=J[a]):t.style.display="none"}function e(){G.style.display="block"}function h(){G.style.display="none"}var i=b.movieWidth,j=b.topPadding,
g=b.leftPadding,l=b.rightPadding,m=b.showTitle,q=b.photoTitleAutoHide,n=b.photoTitleArray,p=b.photoTitleAlpha,k=b.photoTitleColor,r=b.titleTextAlign,w=b.titleTextFont,A=b.titleTextSize,C=b.titleTextShadowColor,D=b.titleTextShadowOffset,U=b.titleTextShadowBlur,P=b.textResize,N=b.textTransform,K=b.textTransformOriginX,H=b.textTransformOriginY,y=b.titleTransform,M=b.titleTransformOriginX,L=b.titleTransformOriginY,O=aJSsTemplate.ColorConverter.hexToRGB(b.photoTitleBackgroundColor),B=b.enableDes,z=b.desLineHeight,
J=b.descriptionText,R=b.desTextFont,s=b.desTextSize,E=b.desTextColor,S=b.desTextAlign,T=b.desTextShadowColor,V=b.desTextShadowOffset,I=b.desTextShadowBlur,F=b.desTransform,v=b.desTransformOriginX,x=b.desTransformOriginY,u=document.createElement("div");a.appendChild(u);u.style.position="absolute";u.style.top=j+"px";u.style.display="block";u.style.width=i-g-l+"px";u.style.backgroundColor="rgba("+O.r+","+O.g+","+O.b+","+p+")";u.style.backgroundRepeat="repeat";u.style.webkitTransform="rotate("+N+"deg)";
u.style.msTransform="rotate("+N+"deg)";u.style.MozTransform="rotate("+N+"deg)";u.style.OTransform="rotate("+N+"deg)";u.style.transform="rotate("+N+"deg)";u.style.transformOrigin=""+H+"px "+K+"px";u.style.webkitTransformOrigin=""+H+"px "+K+"px";u.style.MozTransformOrigin=""+H+"px "+K+"px";u.style.OTransformOrigin=""+H+"px "+K+"px";u.style.resize=""+P+"";u.style.overflow="auto";if("true"==m){var G=document.createElement("div");u.appendChild(G);G.textContent=n[0];G.style.webkitTransform="rotate("+y+
"deg)";G.style.msTransform="rotate("+y+"deg)";G.style.MozTransform="rotate("+y+"deg)";G.style.OTransform="rotate("+y+"deg)";G.style.transform="rotate("+y+"deg)";G.style.transformOrigin=""+L+"px "+M+"px";G.style.webkitTransformOrigin=""+L+"px "+M+"px";G.style.MozTransformOrigin=""+L+"px "+M+"px";G.style.OTransformOrigin=""+L+"px "+M+"px";G.style.color=k;G.style.textAlign=r;G.style.fontFamily=w;G.style.fontSize=A+"px";G.style.textTransform="none";G.style.padding="12px 12px 12px 12px";G.style.fontWeight=
"bold";G.style.textShadow=D+"px "+D+"px "+U+"px "+C;b.commandDispatcher.addEventListener("photoLoadComplete",c);b.commandDispatcher.addEventListener("photoLoadComplete",d)}if("true"==B){var t=document.createElement("div");u.appendChild(t);t.innerHTML=J[0];t.style.webkitTransform="rotate("+F+"deg)";t.style.msTransform="rotate("+F+"deg)";t.style.MozTransform="rotate("+F+"deg)";t.style.OTransform="rotate("+F+"deg)";t.style.transform="rotate("+F+"deg)";t.style.transformOrigin=""+x+"px "+v+"px";t.style.webkitTransformOrigin=
""+x+"px "+v+"px";t.style.MozTransformOrigin=""+x+"px "+v+"px";t.style.OTransformOrigin=""+x+"px "+v+"px";t.style.textAlign=S;t.style.fontSize=s+"px";t.style.color=E;t.style.padding="12px 12px 12px 12px";t.style.fontFamily=R;t.style.lineHeight=z+"px";t.style.textTransform="none";t.style.textShadow=V+"px "+V+"px "+I+"px "+T;b.commandDispatcher.addEventListener("photoLoadComplete",f)}}})();(function(){aJSsTemplate.JsThumbnail=function(b,a){function c(){E.scrollLeft-=2*L+1}function d(){E.scrollLeft+=2*L+1}function f(a){for(var c=a.offsetLeft,b=a.offsetTop,e=[];a=a.offsetParent;)c+=a.offsetLeft,b+=a.offsetTop;e[0]=c;e[1]=b;return e}globalPath=b.globalPath;var e=Number(b.movieWidth),h=Number(b.movieHeight),i=Number(b.topPadding),j=Number(b.leftPadding),g=Number(b.rightPadding),l=b.startAutoPlay,m=b.continuum,q=b.clickToAutoPlay,n=b.musicPath,p=b.musicAutoPlay,k=b.photoArray,r=b.thumbnailArray,
w=b.thumWidth,A=b.thumHeight,C=b.backgroundColor,D=b.currentBackgroundColor,U=b.backgroundAlpha,P=b.numberColor,N=b.currentNumberColor,K=b.thumborder,H=b.buttonColor,y=0,M=aJSsTemplate.ColorConverter.hexToRGB(C),L=0,O=0,B=document.createElement("div");a.appendChild(B);B.style.position="absolute";B.style.top=i+"px";B.style.left=e-g-30+"px";B.style.width="30px";B.style.height="30px";B.style.display="block";B.style.cursor="pointer";B.style.background="url("+globalPath+"res/sound.png)";B.style.backgroundPosition=
"0 0";var z=document.createElement("div");a.appendChild(z);z.id="hiddenThumbnails";z.style.position="absolute";z.style.top=h-35-(A+2*K)-5+"px";z.style.left=j+50+10+15-(w+2*K)/2+"px";z.style.width=w+2*K+"px";z.style.height=b.photoCount*(A+2*K)+"px";var J=document.createElement("div");a.appendChild(J);J.style.position="absolute";J.style.display="none";J.style.top=h-35-5+"px";J.style.left=j+50+10+15-5+"px";J.style.borderLeftStyle="solid";J.style.borderLeftWidth="5px";J.style.borderLeftColor="transparent";
J.style.borderRightStyle="solid";J.style.borderRightWidth="5px";J.style.borderRightColor="transparent";J.style.borderTopStyle="solid";J.style.borderTopWidth="5px";J.style.borderTopColor=C;J.style.width="0px";J.style.height="0px";for(i=0;i<b.photoCount;i++){var R=new Image;R.style.width=w+"px";R.style.height=A+"px";R.style.display="none";R.style.cursor="pointer";R.style.borderWidth=K+"px";R.style.borderStyle="solid";R.style.borderColor=C;R.src=globalPath+r[i];R.alt=k[i];R.index=i;z.appendChild(R)}var s=
document.createElement("div");a.appendChild(s);s.id="thumBody";s.style.position="absolute";s.style.top=h-35+"px";s.style.left=j+50+"px";s.style.width=e-j-g-100+"px";s.style.height="35px";s.style.margin="0px auto";s.style.backgroundColor="rgba("+M.r+","+M.g+","+M.b+","+U+")";s.style.borderRadius="10px 10px 0 0";var E=document.createElement("div");s.appendChild(E);E.id="showThumbnails";E.style.position="absolute";E.style.top="0px";E.style.width=e-j-g-100+"px";E.style.height="35px";var S=parseInt((e-
j-g-100-20-100)/40),T=document.createElement("div");E.appendChild(T);T.id="showArea";T.style.marginLeft="10px";T.style.width=40*S+"px";T.style.height="35px";T.style.overflow="hidden";var V=40*S,h=document.createElement("div");T.appendChild(h);h.id="showAreaUnder";var I=document.createElement("div");E.appendChild(I);I.style.position="absolute";I.style.display="block";I.style.top="7.5px";I.style.left=e-j-g-100-20-100+20+"px";I.style.cursor="pointer";I.style.borderTopStyle="solid";I.style.borderTopWidth=
"10px";I.style.borderTopColor="transparent";I.style.borderBottomStyle="solid";I.style.borderBottomWidth="10px";I.style.borderBottomColor="transparent";I.style.borderRightStyle="solid";I.style.borderRightWidth="10px";I.style.borderRightColor=H;I.style.width="0px";I.style.height="0px";var F=document.createElement("div");E.appendChild(F);F.style.position="absolute";F.style.display="block";F.style.cursor="pointer";F.style.top="7.5px";F.style.left=e-j-g-100-20-100+100-10+"px";F.style.borderTopStyle="solid";
F.style.borderTopWidth="10px";F.style.borderTopColor="transparent";F.style.borderBottomStyle="solid";F.style.borderBottomWidth="10px";F.style.borderBottomColor="transparent";F.style.borderLeftStyle="solid";F.style.borderLeftWidth="10px";F.style.borderLeftColor=H;F.style.width="0px";F.style.height="0px";var v=document.createElement("div");E.appendChild(v);v.style.position="absolute";v.style.top="9.5px";v.style.left=e-j-g-100-20-100+57+"px";v.style.display="block";v.style.borderTopStyle="solid";v.style.borderTopWidth=
"8px";v.style.borderTopColor="transparent";v.style.borderBottomStyle="solid";v.style.borderBottomWidth="8px";v.style.borderBottomColor="transparent";v.style.borderLeftStyle="solid";v.style.borderLeftWidth="8px";v.style.borderLeftColor=H;v.style.width="0px";v.style.height="0px";var x=document.createElement("div");E.appendChild(x);x.style.position="absolute";x.style.top="9.5px";x.style.left=e-j-g-100-20-100+57+"px";x.style.display="none";x.style.width="8px";x.style.height="16px";i=document.createElement("div");
x.appendChild(i);i.style.cssFloat="left";i.style.marginRight="2px";i.style.width="3px";i.style.height="16px";i.style.backgroundColor=H;i=document.createElement("div");x.appendChild(i);i.style.cssFloat="left";i.style.width="3px";i.style.height="16px";i.style.backgroundColor=H;H=document.createElement("div");E.appendChild(H);H.style.position="absolute";H.style.top="9.5px";H.style.left=e-j-g-100-20-100+57+"px";H.style.cursor="pointer";H.style.width="8px";H.style.height="16px";for(var u=[],i=0;i<b.photoCount;i++)u[i]=
"imgPaper";for(i=0;i<b.photoCount;i++)u[i]+=1,u[i]=document.createElement("div"),u[i].style.marginTop="2px",u[i].style.width="30px",u[i].style.cssFloat="left",u[i].style.height="31px",u[i].style.display="block",u[i].style.cursor="pointer",u[i].style.marginRight="10px",u[i].innerHTML=i+1,u[i].style.textAlign="center",u[i].style.fontSize="15px",u[i].style.color=P,u[i].style.fontFamily="Tahoma",u[i].style.fontWeight="bold",u[i].style.lineHeight="30px",u[i].style.textTransform="none",u[i].index=i,h.appendChild(u[i]);
h.style.width=Math.ceil(b.photoCount/S)*V+"px";I.onmouseover=function(){I.style.left=e-j-g-100-20-100+20-2+"px"};I.onmouseout=function(){I.style.left=e-j-g-100-20-100+20+"px"};I.onclick=function(){"true"==l?"true"==q?0<y?(b.Show(y-1,1),v.style.display="none",x.style.display="block",t=0):(b.Show(b.photoCount-1,1),v.style.display="none",x.style.display="block",y=t=0):0<y?(b.Show(y-1,0),v.style.display="block",x.style.display="none",t=1):(b.Show(b.photoCount-1,0),v.style.display="block",x.style.display=
"none",t=1,y=0):"true"==q?0<y?(b.Show(y-1,1),v.style.display="none",x.style.display="block",t=1):(b.Show(b.photoCount-1,1),v.style.display="none",x.style.display="block",t=1,y=0):0<y?(b.Show(y-1,0),v.style.display="block",x.style.display="none",t=0):(b.Show(b.photoCount-1,0),v.style.display="block",x.style.display="none",y=t=0)};F.onmouseover=function(){F.style.left=e-j-g-100-20-100+100-10+2+"px"};F.onmouseout=function(){F.style.left=e-j-g-100-20-100+100-10+"px"};F.onclick=function(){"true"==l?"true"==
q?y<b.photoCount-1?(b.Show(y+1,1),v.style.display="none",x.style.display="block",t=0):(b.Show(0,1),v.style.display="none",x.style.display="block",y=t=0):y<b.photoCount-1?(b.Show(y+1,0),v.style.display="block",x.style.display="none",t=1):(b.Show(0,0),v.style.display="block",x.style.display="none",t=1,y=0):"true"==q?y<b.photoCount-1?(b.Show(y+1,1),v.style.display="none",x.style.display="block",t=1):(b.Show(0,1),v.style.display="none",x.style.display="block",t=1,y=0):y<b.photoCount-1?(b.Show(y+1,0),
v.style.display="block",x.style.display="none",t=0):(b.Show(0,0),v.style.display="block",x.style.display="none",y=t=0)};for(var G=z.getElementsByTagName("img"),i=0;i<b.photoCount;i++)u[i].onmouseover=function(){G[this.index].style.display="block";J.style.display="block";var a=parseInt(this.index/S);z.style.left=j+50+10+15-(w+2*K)/2+40*(this.index-S*a)+"px";J.style.left=j+50+10+15-5+40*(this.index-S*a)+"px";this.style.backgroundColor=D},u[i].onclick=function(){this.style.backgroundColor=D;this.style.color=
N;y=this.index;"true"==l?"true"==q?(b.Show(y,1),v.style.display="none",x.style.display="block",t=0):(b.Show(y,0),v.style.display="block",x.style.display="none",t=1):"true"==q?(b.Show(y,1),v.style.display="none",x.style.display="block",t=1):(b.Show(y,0),v.style.display="block",x.style.display="none",t=0)},u[i].onmouseout=function(){G[this.index].style.display="none";J.style.display="none";y!==this.index&&(u[this.index].style.backgroundColor="rgba("+M.r+","+M.g+","+M.b+",0)",u[this.index].style.color=
P)};b.commandDispatcher.addEventListener("photoLoadComplete",function(a){for(var c=0;c<b.photoCount;c++)u[c].style.backgroundColor="rgba("+M.r+","+M.g+","+M.b+",0)",u[c].style.color=P;y=a.index;u[y].style.backgroundColor=D;u[y].style.color=N;y>=b.photoCount-1&&("false"==m&&"false"==b.randomPlayingPhotos)&&(v.style.display="block",x.style.display="none",b.Pause(),t=0);O=parseInt(y/S);T.scrollLeft=V*O});H.onmouseover=function(){v.style.top="10.5px";v.style.left=e-j-g-100-20-100+58+"px";x.style.top=
"10.5px";x.style.left=e-j-g-100-20-100+58+"px"};H.onmouseout=function(){v.style.top="9.5px";v.style.left=e-j-g-100-20-100+57+"px";x.style.top="9.5px";x.style.left=e-j-g-100-20-100+57+"px"};var t=0;"true"==l?(v.style.display="none",x.style.display="block",H.onclick=function(){0==t?(v.style.display="block",x.style.display="none",b.Pause(),t=1):(v.style.display="none",x.style.display="block",b.Play(),t=0)}):(v.style.display="block",x.style.display="none",H.onclick=function(){0==t?(v.style.display="none",
x.style.display="block",b.Play(),t=1):(v.style.display="block",x.style.display="none",b.Pause(),t=0)});var W=0;""==n?B.style.display="none":"true"==p?(B.style.backgroundPosition="0 0",B.onclick=function(){0==W?(B.style.backgroundPosition="100% 0",b.MusicPause(),W=1):(B.style.backgroundPosition="0 0",b.MusicPlay(),W=0)}):(B.style.backgroundPosition="100% 0",B.onclick=function(){0==W?(B.style.backgroundPosition="0 0",b.MusicPlay(),W=1):(B.style.backgroundPosition="100% 0",b.MusicPause(),W=0)});b.commandDispatcher.addEventListener("soundPlayComplete",
function(){B.innerHTML="stop music";W=1});b.commandDispatcher.addEventListener("videoPlayEnded",function(){v.style.display="none";I.style.left="10px";F.style.left=j+(e-j-g)/2+"px"});for(var L=0,Y=[],i=0;5>i;i++)Y[i]="abc";for(var X=[],i=0;5>i;i++)X[i]="abc";a.onmousemove=function(a){for(var a=a||window.event,b=a.clientX,a=a.clientY,h=0;5>h;h++)b>=f(s)[0]+50*h&&b<=f(s)[0]+50*(h+1)&&a>=f(s)[1]&&a<=f(s)[1]+35?"abc"==Y[h]&&(Y[h]=setInterval(c,10*2*h)):(clearInterval(Y[h]),Y[h]="abc");for(h=0;5>h;h++)L=
h,b>=f(s)[0]+(e-j-g)-50*(h+1)&&b<=f(s)[0]+(e-j-g)-50*h&&a>=f(s)[1]&&a<=f(s)[1]+35?"abc"==X[h]&&(X[h]=setInterval(d,10*2*h)):(clearInterval(X[h]),X[h]="abc")};n=navigator.userAgent;n=n.toLowerCase();switch((/(webkit)[ \/]([\w.]+)/.exec(n)||/(opera)(?:.*version)?[ \/]([\w.]+)/.exec(n)||/(msie) ([\w.]+)/.exec(n)||!/compatible/.test(n)&&/(mozilla)(?:.*? rv:([\w.]+))?/.exec(n)||[])[1]){case "webkit":a.style.height="100%"}}})();(function(){aJSsTemplate.JsMenu=function(b,a){var c=b.movieWidth,d=b.movieHeight,f=b.bottomPadding,e=b.rightPadding,h=b.copyright;if(null==b.anvsoftMenu||"anvsoftPFMTheme"!=h&&"anvsoftUSSTheme"!=h&&"anvsoftHSMTheme"!=h){var i;switch(h){case "anvsoftPFMTheme":i="Photo Slideshow Maker";break;case "anvsoftUSSTheme":i="Ultra Slideshow";break;case "anvsoftHSMTheme":i="HTML5 Slideshow Maker";break;case "anvsoftSWWTheme":i="SlideWow";break;default:i="Anvsoft Photo Slideshow"}var j=document.createElement("div");
...
case "anvsoftUSSTheme":window.open("http://www.ultraslideshow.com/","_self");break;case "anvsoftHSMTheme":window.open("http://www.html5-slideshow-maker.com/","_self");break;case "anvsoftSWWTheme":window.open("http://www.slidewow.com/","_self");break;default:window.open("http://www.anvsoft.com/","_self")}}}}})();(function(){aJSsTemplate.Main=function(b){var b=new aJSsTemplate.ExternalInterface(b),a=b.container;new aJSsTemplate.JsBackground(b,a);new aJSsTemplate.JsText(b,a);new aJSsTemplate.JsThumbnail(b,a);new aJSsTemplate.JsMenu(b,a)}})();(function(b){function a(a,c,b){for(var d=a.length,j=c.length,g,l,m,q,n,p,k=0,r=0;r<d;r++){g=a[r];l=a[r<d-1?r+1:0];k=g.y-l.y;g=l.x-g.x;l=Math.sqrt(k*k+g*g);k/=l;g/=l;l=m=a[0].x*k+a[0].y*g;for(var w=1;w<d;w++)p=a[w].x*k+a[w].y*g,p>m?m=p:p<l&&(l=p);q=n=c[0].x*k+c[0].y*g;for(w=1;w<j;w++)p=c[w].x*k+c[w].y*g,p>n?n=p:p<q&&(q=p);l<q?(l=q-m,k=-k,g=-g):l-=n;if(0<=l)return!1;l>b.overlap&&(b.overlap=l,b.normal.x=k,b.normal.y=g)}return b}var c=b.Quark=b.Quark||{version:"1.0.0",global:b},d=function(){};c.inherit=
...
h*(1-k*d);n=h*k*d;g.y=h*(1-k*d);g.setRect([l,m,q,n]);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),g.setRect([0,0,e,h]),g.y=0,clearInterval(p),p=null}var g=f.getChildAt(0),l=0,m=h,q=e,n=0;c=i*b;d=1/c;var p=setInterval(j,1E3/b),k=1;j()};this.mask6=function(f,e,h,i){function j(){n=e*D*d;g.setRect([m,q,n,p]);k=e*(1-D*d);w=e*D*d;l.x=e*(1-D*d);l.setRect([k,r,w,A]);D++;if(D>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),
g.setRect([0,0,e,h]),f.removeChild(l),clearInterval(C),C=null}var g=f.getChildAt(0),l=new Quark.Bitmap({id:"targetBitmap2",image:g.image,rect:[0,0,0,0]});f.addChild(l);var m=0,q=0,n=0,p=h,k=e,r=0,w=0,A=h;c=i*b;d=1/(2*c);var C=setInterval(j,1E3/b),D=1;j()};this.mask7=function(f,e,h,i){function j(){p=h*D*d;g.setRect([m,q,n,p]);r=h*(1-D*d);A=h*D*d;l.y=h*(1-D*d);l.setRect([k,r,w,A]);D++;if(D>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),g.setRect([0,0,
e,h]),f.removeChild(l),clearInterval(C),C=null}var g=f.getChildAt(0),l=new Quark.Bitmap({id:"targetBitmap2",image:g.image,rect:[0,0,0,0]});f.addChild(l);var m=0,q=0,n=e,p=0,k=0,r=h,w=e,A=0;c=i*b;d=1/(2*c);var C=setInterval(j,1E3/b),D=1;j()};this.mask8=function(f,e,h,i){function j(){l=e/2*(1-k*d);q=e*k*d;g.x=e/2*(1-k*d);g.setRect([l,m,q,n]);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),g.setRect([0,0,e,h]),g.x=0,clearInterval(p),p=null}var g=
...
function(f,e,h,i){function j(){for(n=0;n<K;n++)P=k.length,0<P?(N=Math.floor(Math.random()*P),k[N].visible=!0,k.splice(N,1)):n=K;U++;if(U>c||1==a.maskerFull){aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER});for(g.setRect([0,0,e,h]);1<f.getNumChildren();)f.removeChildAt(f.getNumChildren()-1);clearInterval(D);D=null}}for(var g=f.getChildAt(0),l=g.image,m=Math.ceil(e/20),q=Math.ceil(h/20),n=0,p=0,k=[],n=0;20>n;n++)for(p=0;20>p;p++){var r=m*n,w=q*p,A=m,C=q;r<e&&w<
h&&(r>e-m&&(A=e-r),w>h-q&&(C=h-w),A=new Quark.Bitmap({id:"maskBitmap"+n+p,image:l,rect:[r,w,A,C]}),A.x=r,A.y=w,A.visible=!1,f.addChild(A),k.push(A))}c=i*b;d=1/c;var D=setInterval(j,1E3/b),U=1,P=k.length,N,K=Math.round(P/c);1>K&&(K=1);j()};this.mask13=function(f,e,h,i){function j(){l=e/2*(1-k*d);m=h/2*(1-k*d);q=e*k*d;n=h*k*d;g.x=e/2*(1-k*d);g.y=h/2*(1-k*d);g.setRect([l,m,q,n]);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),g.setRect([0,0,e,h]),
...
0,clearInterval(p),p=null}var g=f.getChildAt(0),l=0,m=h,q=0,n=0;c=i*b;d=1/c;var p=setInterval(j,1E3/b),k=1;j()};this.mask24=function(f,e,h,i){function j(){r=e/2*z*d;w=h/2*z*d;g.setRect([p,k,r,w]);A=e/2+e/2*(1-z*d);C=0;D=e/2*z*d;U=h/2*z*d;m.x=e/2+e/2*(1-z*d);m.setRect([A,C,D,U]);P=0;N=h/2+h/2*(1-z*d);K=e/2*z*d;H=h/2*z*d;q.y=h/2+h/2*(1-z*d);q.setRect([P,N,K,H]);y=e/2+e/2*(1-z*d);M=h/2+h/2*(1-z*d);L=e/2*z*d;O=h/2*z*d;n.x=e/2+e/2*(1-z*d);n.y=h/2+h/2*(1-z*d);n.setRect([y,M,L,O]);z++;if(z>c||1==a.maskerFull){aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER});
for(g.setRect([0,0,e,h]);1<f.getNumChildren();)f.removeChildAt(f.getNumChildren()-1);clearInterval(B);B=null}}var g=f.getChildAt(0),l=g.image,m=new Quark.Bitmap({id:"targetBitmap2",image:l,rect:[0,0,0,0]});f.addChild(m);var q=new Quark.Bitmap({id:"targetBitmap3",image:l,rect:[0,0,0,0]});f.addChild(q);var n=new Quark.Bitmap({id:"targetBitmap4",image:l,rect:[0,0,0,0]});f.addChild(n);var p=0,k=0,r=0,w=0,A=e,C=0,D=0,U=0,P=0,N=h,K=0,H=0,y=e,M=h,L=0,O=0;c=i*b;d=1/c;var B=setInterval(j,1E3/b),z=1;j()};this.mask25=
function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask26=function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask27=function(f,e,h,i){function j(){for(var b=0;b<m;b++){var i=q*b,j=q;n[b].x>e-q&&(j=e-n[b].x);var l=p[b]+(h-p[b])*D*d*h/(h-p[b]);l<h&&n[b].setRect([i,0,j,l])}D++;if(D>c||1==a.maskerFull){aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER});for(g.setRect([0,0,e,h]);1<f.getNumChildren();)f.removeChildAt(f.getNumChildren()-1);clearInterval(C);C=null}}for(var g=
f.getChildAt(0),l=g.image,m=20,q=Math.ceil(e/m),n=[],p=[],k=0;k<m;k++){p[k]=h/2*Math.random();var r=q*k,w=q,A=p[k];r>e-q&&(w=e-r);w=new Quark.Bitmap({id:"maskBitmap"+k,image:l,rect:[r,0,w,A]});w.x=r;f.addChild(w);n.push(w)}c=i*b;d=1/c;var C=setInterval(j,1E3/b),D=1;j()};this.mask28=function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask29=function(f,e,h,i){function j(){g.alpha=m*d;m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),g.alpha=
...
a,b,d,c)};this.mask66=function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask67=function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask68=function(f,e,h,i){function j(){for(n=0;n<z;n++)k[n].width=D[n]*B*d,k[n].height=U[n]*B*d,k[n].x=A[n]+(r[n]-A[n])*B*d,k[n].y=C[n]+(w[n]-C[n])*B*d;B++;if(B>c||1==a.maskerFull){aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER});for(g.setRect([0,0,e,h]);1<f.getNumChildren();)f.removeChildAt(f.getNumChildren()-1);clearInterval(O);
O=null}}for(var g=f.getChildAt(0),l=g.image,m=Math.ceil(e/12),q=Math.ceil(h/12),n=0,p=0,k=[],r=[],w=[],A=[],C=[],D=[],U=[],n=0;12>n;n++)for(p=0;12>p;p++){var P=m*n,N=q*p,K=m,H=q,y=Math.random()*(e-m),M=Math.random()*(h-q);if(P<e&&N<h){P>e-m&&(K=e-P);N>h-q&&(H=h-N);var L=new Quark.Bitmap({id:"maskBitmap"+n+p,image:l,rect:[P,N,K,H]});L.x=y;L.y=M;L.width=0;L.height=0;f.addChild(L);k.push(L);r.push(P);w.push(N);D.push(K);U.push(H);A.push(y);C.push(M)}}c=i*b;d=1/c;var O=setInterval(j,1E3/b),B=1,z=k.length;
j()}}})();
...
(function(){aJSs.JsCompatibleTheme=function(b,a,c){function d(){p--;0>=p&&(clearInterval(r),k++,k>n-1&&(k=0),A.src=c+e[k])}var f=b.movieBackgroundColor,e=b.photoArray,h=b.photoUrlArray,i=b.photoTimeArray,j=b.transitionTimeArray,g=b.URLTarget,l=b.topPadding,m=b.bottomPadding,q=b.leftPadding,b=b.rightPadding,n=e.length,p=0,k=0,r=null,w=document.getElementById(a);w.style.backgroundColor=f;var a=w.offsetWidth,f=w.offsetHeight,q=a-q-b,l=f-l-m,m=Math.round((a-q)/2),b=Math.round((f-l)/2),A=new Image;w.appendChild(A);
A.style.position="absolute";A.style.width=q+"px";A.style.height=l+"px";A.style.left=m+"px";A.style.top=b+"px";A.src=c+e[k];A.onload=function(){p=parseInt(j[k])+parseInt(i[k]);r=setInterval(d,1E3)};A.onclick=function(){var a;switch(g[k]){case "0":a="_blank";break;case "1":a="_parent";break;case "2":a="_self";break;case "3":a="_top";break;default:a="_blank"}window.open(h[k],a)};var C=document.createElement("div");w.appendChild(C);C.style.position="absolute";C.style.width="250px";C.style.padding="8px";
C.style.backgroundColor="#333";C.style.color="#FFF";C.style.textAlign="left";C.style.font="normal normal 12px/16px verdana,tahoma,arial,sans-serif";C.innerHTML="The browser you are using does not support HTML5. Now you are using the simple compatible mode. To get better user experience, please use HTML5 supported browser.";C.style.left=Math.round((a-C.offsetWidth)/2)+"px";C.style.top=Math.round((f-C.offsetHeight)/2)+"px";var D=setTimeout(function(){clearTimeout(D);D=null;w.removeChild(C)},1E4)}})();
...
(function(){aJSs.JsPhoto=function(b,a,c){function d(){aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.VIDEO_CLEAR});if(""!=D){e();var a=new Image;a.src=c+D;a=new Quark.MovieClip({image:a,id:"preloader",interval:100});a.addFrame([{rect:[0,0,25,25]},{rect:[25,0,25,25]},{rect:[50,0,25,25]},{rect:[75,0,25,25]},{rect:[100,0,25,25]},{rect:[125,0,25,25]}]);a.x=w+(H-a.width)/2;a.y=k+(y-a.height)/2;V.addChild(a)}B=O=0;W&&W.removeAllChildren();t.swapChildren(X,Z);t.getChildIndex(X)>t.getChildIndex(Z)?
(Y=X,W=Z):(Y=Z,W=X);var b=new Image;b.onload=function(){e();O=1;b.width=I;b.height=F;var a=new Quark.Bitmap({id:"targetBitmap",image:b,rect:[0,0,0.0010,0.0010]});a.useHandCursor="true"==g&&""!=j[s]?!0:!1;Y.addChild(a);J=0==q[s]?null==n?Math.floor(Math.random()*T.transTotal)+1:n[Math.floor(Math.random()*n.length)]:q[s];T.transition(J,Y,I,F,p[s]);a.onEvent=function(a){if("mousedown"==a.type||"touchend"==a.type){if("true"==g&&""!=j[s]){switch(l[s]){case "0":a="_blank";break;case "1":a="_parent";break;
...
index:s});s>=S-1&&"false"==P&&"false"==C&&M.Pause()}function f(){R--;try{Quark.getDOM("debugInfo").value=R}catch(a){}if(0>=R||1==z)clearInterval(E),E=null,0==z?"true"==C?s=Math.floor(Math.random()*S):s<S-1?s++:s=0:z=0,d()}function e(){if(""!=D){var a=V.getChildById("preloader");null!=a&&V.removeChild(a)}}var h=b.frameRate,i=b.photoArray,j=b.photoUrlArray,g=b.enableURL,l=b.URLTarget,m=b.photoTimeArray,q=b.transitionArray,n=b.defineTransitionArray,p=b.transitionTimeArray,k=b.topPadding,r=b.bottomPadding,
w=b.leftPadding,A=b.rightPadding,C=b.randomPlayingPhotos,D=b.loadStyle,U=b.startAutoPlay,P=b.continuum,N=b.videoAutoPlay,K=b.videoArray,H=a.width-w-A,y=a.height-k-r,M=this,L=0,O=1,B=1,z=0,J=0,R=0,s=0,E=null,S=i.length;aJSs.CommandDispatcher.getInstance().addEventListener(aJSs.Events.TRANSITION_OVER,function(){B=1;if(1==L||1==z)R=m[s]*h,E=setInterval(f,1E3/h);""!=K[s]&&void 0!=K[s]&&0==z&&("true"==N&&(clearInterval(E),E=null),aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.PLAY_VIDEO,
index:s,width:H,height:y}))});aJSs.CommandDispatcher.getInstance().addEventListener(aJSs.Events.PLAY_NEXT,function(){M.Play()});aJSs.CommandDispatcher.getInstance().addEventListener(aJSs.Events.VIDEO_START_PLAY,function(){M.Pause()});var T=new aJSs.MaskEffect(h),V=new Quark.DisplayObjectContainer({id:"container"});V.autoSize=!0;a.addChild(V);var I=a.width-w-A,F=a.height-k-r,b=w,a=k,r=Quark.Bitmap,A=I,v=F,x="#DDD",u=document.createElement("canvas");u.width=A;u.height=v;var G=u.getContext("2d");G.fillStyle=
x;G.rect(0,0,A,v);G.fill();x=new Image;x.src=u.toDataURL("image/png");x.width=A;x.height=v;r=new r({id:"photoBoxBg",image:x});r.autoSize=!0;r.x=b;r.y=a;V.addChild(r);var t=new Quark.DisplayObjectContainer({id:"photoBox",x:b,y:a,width:I,height:F});t.autoSize=!0;V.addChild(t);var W,Y,X=new Quark.DisplayObjectContainer({id:"aPhoto"}),Z=new Quark.DisplayObjectContainer({id:"bPhoto"});t.addChild(X);t.addChild(Z);this.Play=function(){L=1;1==O&&1==B?(clearInterval(E),E=null,s<S-1?s++:s=0,d()):1==O&&0==B?
(z=1,s<S-1?s++:s=0,T.maskerFull=1):(s<S-1?s++:s=0,z=1)};this.Pause=function(){L=0;null!=E&&(clearInterval(E),E=null)};this.Previous=function(a){L=a;0<s?s--:s=S-1;1==O&&1==B?(clearInterval(E),E=null,d()):1==O&&0==B?(z=1,T.maskerFull=1):z=1};this.Next=function(a){L=a;s<S-1?s++:s=0;1==O&&1==B?(clearInterval(E),E=null,d()):1==O&&0==B?(z=1,T.maskerFull=1):z=1};this.Show=function(a,b){L=b;1==O&&1==B?(clearInterval(E),E=null,s=a,d()):1==O&&0==B?(z=1,s=a,T.maskerFull=1):(s=a,z=1)};"true"==U?this.Show(0,1):
this.Show(0,0)}})();
(function(){aJSs.JsMediaConsole=function(b,a,c,d){function f(){void 0!=r&&(b.removeChild(r),void 0!=k&&"videoCallPause"==w&&(k.Play(),w=""),r=void 0,e())}function e(){var a=document.getElementById("videoLoadText");a&&b.removeChild(a)}var h=a.topPadding,i=a.leftPadding,c=a.musicPath,j=a.musicAutoPlay,g=a.musicLoop,l=a.musicStream,m=a.videoAutoPlay,q=a.bufferTime,n=a.videoArray,p=a.videoControls;if(""!=c)var k=new aJSs.Music(d+c,l,j,g);var r,w="";aJSs.CommandDispatcher.getInstance().addEventListener(aJSs.Events.PLAY_VIDEO,function(a){var c=
a.index,e=a.width,a=a.height;void 0!=k&&k.Playing()&&(k.Pause(),w="videoCallPause");r=new aJSs.Video(d+n[c],m,q,p,e,a);r.style.backgroundColor="#000";r.style.position="absolute";r.style.top=h+"px";r.style.left=i+"px";b.appendChild(r);c=document.getElementById("videoLoadText");null==c&&(c=document.createElement("div"),c.id="videoLoadText",c.style.position="absolute",c.style.top=h+5+"px",c.style.left=i+5+"px",c.style.font="normal normal 11px/13px verdana,tahoma,arial,sans-serif",c.style.color="#FFF",
