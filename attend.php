...
<script>
	...
	$nameArray = ['anderson', 'babcock', 'baumgart', 'bergstromd', 'cahill', 'camacho', 'dewolf', 'dillenback', 'english', 'fasheha', 'fashehj', 'fassnacht', 'feinblatts', 'ferkle', 'frederick', 'gardnerja', 'gardnerji', 'hartungj', 'kaczmarek', 'kingd', 'kingr', 'lam', 'leete', 'liu', 'lum', 'martin', 'mascarenhas', 'mcdiarmid', 'morton', 'neff', 'noguer', 'obert', 'prum', 'rutherford', 'sahyounie', 'sahyounis', 'shoukry', 'singer', 'suzuki', 'thornton', 'tillotson', 'trirogoff', 'tsai', 'unger', 'walter', 'wolff'];
	
	$carNameArray = ['amy', 'angela', 'elias', 'jimh', 'john', 'julie', 'patty', 'phil', 'ralph', 'robert', 'shirley', 'sonia', 'tona', 'tricia'];
...
<div align="center">
  <table width="600" border="0" cellspacing="1" cellpadding="5">
		  ...
		  <table width="90%" bordercolor="#ababab" border="1" cellspacing="0" cellpadding="3">
            ...
            <tr>
              ...
              <?php $index = $index + 1 ?>
				...
				<tr>
              <td width="292">English, Tricia</td>
              
              <td width="112" align="center"><input type="radio" name="english" id="englishyes" value="Yes" <?php if ($rsvpArray[$index] == 'yes'){ echo 'checked'; $yes = $yes + 1; } ?>></td>
              
              <td width="112" align="center"><input type="radio" name="english" id="englishno" value="No" <?php if ($rsvpArray[$index] == 'no'){ echo 'checked'; $no = $no + 1; } ?>></td>
              
              <td width="112" align="center"><input type="radio" name="english" id="englishnr" value="NR" <?php if ($rsvpArray[$index] == 'nr'){ echo 'checked'; $nr = $nr + 1; } ?>></td>
            ...
            <tr>
              ...
              <?php $index = $index + 1 ?>
				...
				<tr>
              <td width="292">Thornton, Julie</td>
             
              <td width="112" align="center"><input type="radio" name="thornton" id="thorntonyes" value="Yes" <?php if ($rsvpArray[$index] == 'yes'){ echo 'checked'; $yes = $yes + 1; } ?>></td>
              
              <td width="112" align="center"><input type="radio" name="thornton" id="thorntonno" value="No" <?php if ($rsvpArray[$index] == 'no'){ echo 'checked'; $no = $no + 1; } ?>></td>
              
              <td width="112" align="center"><input type="radio" name="thornton" id="thorntonnr" value="NR" <?php if ($rsvpArray[$index] == 'nr'){ echo 'checked'; $nr = $nr + 1; } ?>></td>
			...
			<tr>
              <td width="292">Trirogoff, Kristina</td>
             
              <td width="112" align="center"><input type="radio" name="trirogoff" id="trirogoffyes" value="Yes" <?php if ($rsvpArray[$index] == 'yes'){ echo 'checked'; $yes = $yes + 1; } ?>></td>
              
              <td width="112" align="center"><input type="radio" name="trirogoff" id="trirogoffno" value="No" <?php if ($rsvpArray[$index] == 'no'){ echo 'checked'; $no = $no + 1; } ?>></td>
              
              <td width="112" align="center"><input type="radio" name="trirogoff" id="trirogoffnr" value="NR" <?php if ($rsvpArray[$index] == 'nr'){ echo 'checked'; $nr = $nr + 1; } ?>></td>
			...
			<tr>
              <td width="292">Walter, Dave</td>
             
              <td width="112" align="center"><input type="radio" name="walter" id="walteryes" value="Yes" <?php if ($rsvpArray[$index] == 'yes'){ echo 'checked'; $yes = $yes + 1; } ?>></td>
              
              <td width="112" align="center"><input type="radio" name="walter" id="walterno" value="No" <?php if ($rsvpArray[$index] == 'no'){ echo 'checked'; $no = $no + 1; } ?>></td>
              
              <td width="112" align="center"><input type="radio" name="walter" id="walternr" value="NR" <?php if ($rsvpArray[$index] == 'nr'){ echo 'checked'; $nr = $nr + 1; } ?>></td>
    ...
    <br>
    1: OPEN A <u>NEW</u> ATTENDANCE PAGE IN THE BROWSER. DO NOT USE AN ATTENDANCE PAGE THAT IS ALREADY OPEN.<br> 
...
4: <u>CLOSE</u> THE ATTENDANCE PAGE. YOU ARE DONE.</strong></font></p>
  
    <p align="left"><font color="#ff0000"><strong>
        5: IF YOU SEE A POP-UP MESSAGE IN STEP 2, HIT <u>CANCEL</u>, EXIT THE ATTENDANCE PAGE, THEN RE-ENTER THE ATTENDANCE PAGE.<br>
...
<div id="navigation"> &nbsp;&nbsp;&nbsp; <a href="index.html" title="Home">Home</a>&nbsp;&nbsp;&nbsp; <a href="about.html" title="About">About</a>&nbsp;&nbsp;&nbsp; <a href="site_map.html" title="Site-Map">Site-Map</a>&nbsp;&nbsp;&nbsp; <a href="schedule.html" title="Schedule">Schedule</a>&nbsp;&nbsp;&nbsp; <a href="attend.php" title="Attendance">Attendance</a>&nbsp;&nbsp;&nbsp; <a href="leader.html" title="Leader">Leader</a>&nbsp;&nbsp;&nbsp; <a href="description.html" title="Description">Description</a>&nbsp;&nbsp;&nbsp; <a href="history.html" title="History">History</a>&nbsp;&nbsp;&nbsp; <a href="database.html" title="Database">Database</a>&nbsp;&nbsp;&nbsp; <a href="safety.html" title="Safety">Safety</a>&nbsp;&nbsp;&nbsp; <a href="site_information.html" title="Site-Information">Site-Information</a>&nbsp;&nbsp;&nbsp; <a href="notices.html" title="News & Notices">News/Notices</a>&nbsp;&nbsp;&nbsp; <a href="trip_plan.html" title="Trip-Plan">Trip-Plan</a>&nbsp;&nbsp;&nbsp; <a href="links.html" title="External Links">Links</a>&nbsp;&nbsp;&nbsp; <a href="photos.html" title="Photos">Photos</a>&nbsp;&nbsp;&nbsp; <a href="photos.html" title="Videos">Videos</a>&nbsp;&nbsp;&nbsp; <a href="mikes_page.html" title="Mike's Page">Mike's Page</a>&nbsp;&nbsp;&nbsp; <a href="Memorial.html" title="Memorial">Memorial</a>&nbsp;&nbsp;&nbsp; <a href="contacts.html" title="Contacts">Contacts </a> </div>
<!-- #EndLibraryItem -->
...
Last updated at 11:26 am PST on 12/19/2024<br>
