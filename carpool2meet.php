...
<div align="center">
  ...
  <table width="600" border="0" cellspacing="1" cellpadding="0">
    <tr>
      <td><p align="left">Please indicate your availability for <a href="hikes/1315.html">Hike #1315, Rocky Peak via Chumash Trail</a>, on Wednesday, April 19, 2017. </p>
    ...
    <p align="left">Click Submit to save your entry.</p>
        ...
        <table width="495" bordercolor="#ababab" border="1" cellspacing="0" cellpadding="3">
          ...
          <form name="myform1" method="post">
            <tr>
              <th height="49" colspan="9" scope="col"><p><a href="hikes/1315.html">Hike #1315, Rocky Peak via Chumash Trail</</a><br>Wednesday, April 19, 2017<br>
            ...
            <tr>
              ...
              <td align="center"><input type="radio" name="meet1" id="meet1anna" value="anna" <?php if ($statusNameArray['1'] == 'anna'){ echo 'checked'; } ?>></td>
              <td align="center"><input type="radio" name="driver2" id="driver2anna" value="anna" <?php if ($statusNameArray['2'] == 'anna'){ echo 'checked'; } ?>></td>
              <td align="center"><input type="radio" name="meet2" id="meet2anna" value="anna" <?php if ($statusNameArray['3'] == 'anna'){ echo 'checked'; } ?>></td>
            </tr>
              <tr>
              <td align="center">Carol</td>
              <td align="center">5</td>
              <td align="center"><input type="radio" name="carol" id="carolyes" value="Yes" <?php if ($rsvpArray[1] == 'yes'){ echo 'checked'; } ?>></td>
              <td align="center"><input type="radio" name="carol" id="carolno" value="No" <?php if ($rsvpArray[1] == 'no'){ echo 'checked'; } ?>></td>
              <td align="center"><input type="radio" name="carol" id="carolnr" value="NR" <?php if ($rsvpArray[1] == 'nr'){ echo 'checked'; } ?>></td>
              <td align="center"><input type="radio" name="driver1" id="driver1carol" value="carol" <?php if ($statusNameArray['0'] == 'carol'){ echo 'checked'; } ?>></td>
              <td align="center"><input type="radio" name="meet1" id="meet1carol" value="carol" <?php if ($statusNameArray['1'] == 'carol'){ echo 'checked'; } ?>></td>
              <td align="center"><input type="radio" name="driver2" id="driver2carol" value="carol" <?php if ($statusNameArray['2'] == 'carol'){ echo 'checked'; } ?>></td>
              <td align="center"><input type="radio" name="meet2" id="meet2carol" value="carol" <?php if ($statusNameArray['3'] == 'carol'){ echo 'checked'; } ?>></td>
            </tr>
            <tr>
              <td align="center">Grant</td>
              <td align="center">5</td>
              <td align="center"><input type="radio" name="grant" id="grantyes" value="Yes" <?php if ($rsvpArray[2] == 'yes'){ echo 'checked'; } ?>></td>
              <td align="center"><input type="radio" name="grant" id="grantno" value="No" <?php if ($rsvpArray[2] == 'no'){ echo 'checked'; } ?>></td>
              <td align="center"><input type="radio" name="grant" id="grantnr" value="NR" <?php if ($rsvpArray[2] == 'nr'){ echo 'checked'; } ?>></td>
              <td align="center"><input type="radio" name="driver1" id="driver1grant" value="grant" <?php if ($statusNameArray['0'] == 'grant'){ echo 'checked'; } ?>></td>
              <td align="center"><input type="radio" name="meet1" id="meet1grant" value="grant" <?php if ($statusNameArray['1'] == 'grant'){ echo 'checked'; } ?>></td>
              <td align="center"><input type="radio" name="driver2" id="driver2grant" value="grant" <?php if ($statusNameArray['2'] == 'grant'){ echo 'checked'; } ?>></td>
              <td align="center"><input type="radio" name="meet2" id="meet2grant" value="grant" <?php if ($statusNameArray['3'] == 'grant'){ echo 'checked'; } ?>></td>
            </tr>
            <tr>
              ...
              <td align="center"><input type="radio" name="meet1" id="meet1jimc" value="jimc" <?php if ($statusNameArray['1'] == 'jimc'){ echo 'checked'; } ?>></td>
              <td align="center"><input type="radio" name="driver2" id="driver2jimc" value="jimc" <?php if ($statusNameArray['2'] == 'jimc'){ echo 'checked'; } ?>></td>
              <td align="center"><input type="radio" name="meet2" id="meet2jimc" value="jimc" <?php if ($statusNameArray['3'] == 'jimc'){ echo 'checked'; } ?>></td>
            </tr>
            <tr>
          ...
          <td align="center"><input type="radio" name="driver1" id="driver1jimh" value="jimh" <?php if ($statusNameArray['0'] == 'jimh'){ echo 'checked'; } ?>></td>></td>
              <td align="center"><input type="radio" name="meet1" id="meet1jimh" value="jimh" <?php if ($statusNameArray['1'] == 'jimh'){ echo 'checked'; } ?>></td>
              <td align="center"><input type="radio" name="driver2" id="driver2jimh" value="jimh" <?php if ($statusNameArray['2'] == 'jimh'){ echo 'checked'; } ?>></td>
              <td align="center"><input type="radio" name="meet2" id="meet2jimh" value="jimh" <?php if ($statusNameArray['3'] == 'jimh'){ echo 'checked'; } ?>></td>
            </tr>
            <tr>
              ...
              <td align="center"><input type="radio" name="meet1" id="meet1joel" value="joel" <?php if ($statusNameArray['1'] == 'joel'){ echo 'checked'; } ?>></td>
              <td align="center"><input type="radio" name="driver2" id="driver2joel" value="joel" <?php if ($statusNameArray['2'] == 'joel'){ echo 'checked'; } ?>></td>
              <td align="center"><input type="radio" name="meet2" id="meet2joel" value="joel" <?php if ($statusNameArray['3'] == 'joel'){ echo 'checked'; } ?>></td>
            </tr>
            ...
            <tr>
              ...
              <td align="center"><input type="radio" name="meet1" id="meet1john" value="john" <?php if ($statusNameArray['1'] == 'john'){ echo 'checked'; } ?>></td>
              <td align="center"><input type="radio" name="driver2" id="driver2john" value="john" <?php if ($statusNameArray['2'] == 'john'){ echo 'checked'; } ?>></td>
              <td align="center"><input type="radio" name="meet2" id="meet2john" value="john" <?php if ($statusNameArray['3'] == 'john'){ echo 'checked'; } ?>></td>
            </tr>
            ...
            <tr>
              ...
              <td align="center"><input type="radio" name="meet1" id="meet1phil" value="phil" <?php if ($statusNameArray['1'] == 'phil'){ echo 'checked'; } ?>></td>
              <td align="center"><input type="radio" name="driver2" id="driver2phil" value="phil" <?php if ($statusNameArray['2'] == 'phil'){ echo 'checked'; } ?>></td>
              <td align="center"><input type="radio" name="meet2" id="meet2phil" value="phil" <?php if ($statusNameArray['3'] == 'phil'){ echo 'checked'; } ?>></td>
            </tr>
            <tr>
              ...
              <td align="center"><input type="radio" name="meet1" id="meet1ralph" value="ralph" <?php if ($statusNameArray['1'] == 'ralph'){ echo 'checked'; } ?>></td>
              <td align="center"><input type="radio" name="driver2" id="driver2ralph" value="ralph" <?php if ($statusNameArray['2'] == 'ralph'){ echo 'checked'; } ?>></td>
              <td align="center"><input type="radio" name="meet2" id="meet2ralph" value="ralph" <?php if ($statusNameArray['3'] == 'ralph'){ echo 'checked'; } ?>></td>
            </tr>
            <tr>
              ...
              <td align="center"><input type="radio" name="meet1" id="meet1shirley" value="shirley" <?php if ($statusNameArray['1'] == 'shirley'){ echo 'checked'; } ?>></td>
              <td align="center"><input type="radio" name="driver2" id="driver2shirley" value="shirley" <?php if ($statusNameArray['2'] == 'shirley'){ echo 'checked'; } ?>></td>
              <td align="center"><input type="radio" name="meet2" id="meet2shirley" value="shirley" <?php if ($statusNameArray['3'] == 'shirley'){ echo 'checked'; } ?>></td>
            </tr>
            <tr>
              ...
              <td align="center"><input type="radio" name="meet1" id="meet1vicky" value="vicky" <?php if ($statusNameArray['1'] == 'vicky'){ echo 'checked'; } ?>></td>
              <td align="center"><input type="radio" name="driver2" id="driver2vicky" value="vicky" <?php if ($statusNameArray['2'] == 'vicky'){ echo 'checked'; } ?>></td>
              <td align="center"><input type="radio" name="meet2" id="meet2vicky" value="vicky" <?php if ($statusNameArray['3'] == 'vicky'){ echo 'checked'; } ?>></td>
            </tr>
            <tr>
              <td colspan="5"> Undetermined Driver and Meeting Location</td>
              <td align="center"><input type="radio" name="driver1" id="driver1ud" value="udml" <?php if ($statusNameArray['0'] == 'udml'){ echo 'checked'; } ?>></td>
              <td align="center"><input type="radio" name="meet1" id="meet1uml" value="udml" <?php if ($statusNameArray['1'] == 'udml'){ echo 'checked'; } ?>></td>
              <td align="center"><input type="radio" name="driver2" id="driver2ud" value="udml" <?php if ($statusNameArray['2'] == 'udml'){ echo 'checked'; } ?>></td>
              <td align="center"><input type="radio" name="meet2" id="meet2uml" value="udml" <?php if ($statusNameArray['3'] == 'udml'){ echo 'checked'; } ?>></td>
            </tr>
            </p>
          </tbody>
        </table>
  ...
  <div id="footer_left">
Copyright &copy; 1989-2017 OTP Hiker<br>
Last updated at 10:45 am PDT on 04/13/2017<br>
